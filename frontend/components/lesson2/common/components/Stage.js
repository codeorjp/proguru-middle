...
import ClientServerAnimation from "./ClientServerAnimation";
        ...
        <div className={mainContent}>
          <PlayGroundWrap>
            <div className={playGround}>
              <LessonCard id={tourSelecters.clientServerAnimation}>
                <ClientServerAnimation />
              </LessonCard>
              <LessonCard id={tourSelecters.terminal} noPadding>
                <Terminal />
              </LessonCard>
            </div>
          </PlayGroundWrap>
