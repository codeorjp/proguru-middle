...
describe("Lesson2 Stage6", () => {
  test("build blocks -> eval code", async () => {
    ...
    const textMyName = workspace.newBlock("textMyName");
    ...
    send.getInput("VARNAME").connection.connect(textMyName.outputConnection);
    send.nextConnection.connect(receiveResponse.previousConnection);
    receiveResponse
      .getInput("DO")
